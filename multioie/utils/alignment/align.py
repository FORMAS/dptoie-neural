...
from multioie.utils.alignment.alignment import Alignment
from multioie.utils.alignment.utils import flatten, merge
...
def multi_sequence_alignment(
    ...
    matrix = pairwise_distances(
        sequences,
        partial(align_sequences, scoring_fn=scoring_fn, gap_penalty=gap_penalty, scale=scale),
    )
...
if __name__ == "__main__":
    sequences = [
        "Olá tudo bem, meu nome é Bruno Cabral".split(),
        "Olá tudo".split(),
        "Bruno Cabral".split(),
    ]
