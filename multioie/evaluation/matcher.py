...
class Matcher:
    ...
    @staticmethod
    def identicalMatch(ref, ex, ignoreStopwords, ignoreCase):
        ...
        arg1_match = arg1_ref == arg1_pred
        rel_match = rel_ref == rel_pred
        arg2_match = arg2_ref == arg2_pred

        return arg1_match and rel_match and arg2_match
